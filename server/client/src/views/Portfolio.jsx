            ...
            <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <div className="max-w-xl">
                <p className="mt-6 text-white">
                  DadScript.com is a personal blog meticulously designed and developed to document my journey as a
                  software developer. It features insightful articles, comprehensive tutorials, and showcases of my
                  projects. The blog is built using a robust tech stack, including React, JavaScript, MongoDB, CSS,
                  Tailwind CSS, and Render services.
                </p>
                <a className="text-indigo-200 hover:text-indigo-100" href="https://github.com/alanmmeachum/DadScriptV3">
                  <span className="sr-only">GitHub</span>
                  <svg
                    className=" pt-1 h-10 w-8 alan_font_color"
                    aria-hidden="true"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
