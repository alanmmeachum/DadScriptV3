      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
        <div className="relative bg-white shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            {/* Contact information */}
            <div className="relative overflow-hidden alan_background_color px-6 py-10 sm:px-10 xl:p-12">
              <div
              ...
              <p className="mt-6 max-w-3xl text-base text-indigo-50">
                If you are interested in chatting, send a message here or email.
              </p>
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  <PhoneIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3 italics">
                    (Disclosed upon messaging)
                  </span>
                </dd>
                <dt>
                ...
                <dd className="flex text-base text-indigo-50">
                  <EnvelopeIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3">alanmmeachum@gmail.com</span>
                </dd>
              </dl>
