          ...
          {allBlogs.map((blog) => (                                                  
            <article key={blog._id} className="py-12">
              <div className="group relative max-w-xl">
                <time dateTime={blog.date} className="block text-sm leading-6 text-white">
                  {blog.date}
                </time>
                ...
                <p className="mt-4 text-sm leading-6 text-white">{blog.description}</p>
              ...
              <div className="mt-4 flex">
                ...
                >
                  <img src={null} alt="" className="h-6 w-6 flex-none rounded-full bg-gray-50" />
